...
double blackbox::zero_oracle_dense(double* X, double* Y, int N, double* weights) const {
    return zero_component_oracle_dense(X, Y, N, weights) + zero_regularizer_oracle(weights);//É¾µôzero
}
